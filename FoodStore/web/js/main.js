...
//            e.preventDefault();
//            const target = $(this).attr('href'); // Lấy giá trị href tương ứng
//            $('.box-container').removeClass('active'); // Ẩn tất cả các box-container
//            $(target).addClass('active'); // Hiển thị box-container tương ứng với tab được chọn
//        });
//    });
